...
import mostroBlack from './mostroBlack.png';
import mostroWhite.png from './mostroWhite.png';
...
export const headerLogoBlack = mostroBlack;
export const headerLogoWhite = mostroWhite.png;
